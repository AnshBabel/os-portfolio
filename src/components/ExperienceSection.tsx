...
const commits = [
  {
    ...
    duration: "30+ Hours",
    date: "2025-01",
    description: "Completed 30+ hours of advanced Data Structures and Algorithms. Optimized 100+ challenges for time and space complexity.",
  ...
  {
    hash: "b5c3d4e",
    tag: "achievement -> silver_medal",
    title: "2nd Position - Innovation Sprint",
    organization: "Hackathon 2025",
    duration: "Feb 2025",
    date: "2025-02",
    description: "Led team to 2nd place among 50+ participants. Built a high-performance financial dashboard with real-time API sync in 48 hours.",
